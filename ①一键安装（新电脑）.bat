...
rem
rem  This file only forwards to installer\auto\ so you do not have to
rem  dig through the sub-folders.
rem
...
rem  The Chinese-named launcher inside installer\auto\ is found by wildcard
rem  on purpose - never type its name in here.
rem =====================================================================
setlocal
set "TARGET_DIR=%~dp0installer\auto"
